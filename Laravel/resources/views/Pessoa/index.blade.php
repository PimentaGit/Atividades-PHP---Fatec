...
<div class="container mt-5">
    ...
    @endif
    <a href="{{route('pessoa.create')}}">Adicionar Pessoa</a><br><br><br>
    <div class="c">
        ...
        <tr>
            ...
            <td>{{ $p->telefone }}</td>
            <td>
                <a class="c" href="{{ route('pessoa.edit', $p->id) }}" class="btn btn-info">Editar</a><br>
                <form class= "c" action="{{ route('pessoa.destroy', $p->id) }}" method="POST" class="d-inline">
                    @csrf
                    @method('DELETE')
