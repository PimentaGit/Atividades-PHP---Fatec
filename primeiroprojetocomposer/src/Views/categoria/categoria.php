...
<body>
    <main class="container">
        <h1>Categorias</h1>
        <a href="/categoria/inserir" class="btn btn-primary">Nova Categoria</a><br>
        <p><?= $mensagem ?></p>
            ...
            <tbody>
                ...
                ?>
                    <tr>
                        <td><?= $c['descricao'] ?></td>
                        <td>
                            <a href="/categoria/alterar/id/<?= $c["id"]?>" class="btn btn-warning"> Alterar</a>
                            <a href="/categoria/excluir/id/<?= $c["id"]?>" class="btn btn-danger"> Excluir</a>
                        </td>
                    </tr>
                <?php
                }
